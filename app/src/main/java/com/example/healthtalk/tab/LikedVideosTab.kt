...
import com.example.healthtalk.databinding.FragmentLikedVideosTabBinding
...
class LikedVideosTab(private var userId: String) : Fragment(), RecyclerViewInterface {
    private lateinit var binding: FragmentLikedVideosTabBinding
